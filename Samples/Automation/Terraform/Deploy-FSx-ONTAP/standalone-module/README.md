...
```shell
cd FSx-ONTAP-utils/Samples/Automation/Terraform/Deploy-FSx-ONTAP/standalone-module
```
...
Downloading git::https://github.com/Netapp/FSx-ONTAP-utils.git for fsxn_rotate_secret...
- fsxn_rotate_secret in .terraform/modules/fsxn_rotate_secret/Management-Utilities/fsxn-rotate-secret/terraform
Downloading git::https://github.com/Netapp/FSx-ONTAP-utils.git for svm_rotate_secret...
