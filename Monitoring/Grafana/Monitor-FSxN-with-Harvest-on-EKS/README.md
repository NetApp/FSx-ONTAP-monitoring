...
* An EKS cluster. If you don't have one, you can follow the instructions from another one of our samples [FSxN-as-PVC-for-EKS](https://github.com/NetApp/FSx-ONTAP-utils/tree/main/EKS/FSxN-as-PVC-for-EKS). Follow the instructions up to the point where it suggests you create a "stateful application."
...
```
cd FSx-ONTAP-utils/Monitoring/Grafana/Monitor-FSxN-with-Havest-on-EKS/HelmChart
```
