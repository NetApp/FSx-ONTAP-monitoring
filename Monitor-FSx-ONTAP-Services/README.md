...
|ImplementWatchdogAsLambda|Set to "true" if you want the CloudWatch alarm to send the SNS alert using a Lambda function. This is done so the SNS topic can be in another region since CloudWatch doesn't support doing that natively.|
